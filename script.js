function carregar(){
    ...
    if (nota >=7){
        ...
        msg.innerHTML = `Sua nota foi <strong>${nota}</strong> e você foi: <strong>APROVADO!</strong>`
        ...
        msg.innerHTML = `Sua nota foi <strong>${nota}</strong> e você foi: <strong>REPROVADO!</strong>`
